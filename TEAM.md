...
- Phần việc và file/commit/PR: Cải thiện `starter_v0/artifacts/system_prompt.md` và `starter_v0/artifacts/tools.yaml`; tạo `starter_v0/data/eval_group.json`; cập nhật `starter_v0/artifacts/version_log.csv` và `starter_v0/artifacts/REPORT.md`; commit: CHƯA COMMIT; PR: N/A.
